	...
	return []Trip{
		{
			...
			HeaderPhoto: "/api/image/paris-header",
			...
			Checkpoints: []Checkpoint{
				{
					...
					Photos:      []string{"/api/image/paris-1", "/api/image/paris-2"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/eiffel-1", "/api/image/eiffel-2", "/api/image/eiffel-3"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/louvre-1", "/api/image/louvre-2", "/api/image/louvre-3"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/rome-flight"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/rome-arrival-1", "/api/image/rome-arrival-2"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/colosseum-1", "/api/image/colosseum-2", "/api/image/colosseum-3"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/vatican-1", "/api/image/vatican-2"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/florence-flight"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/florence-1", "/api/image/florence-2", "/api/image/florence-3"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/uffizi-1", "/api/image/uffizi-2"},
				...
				},
				{
					...
					Photos:      []string{"/api/image/departure-1", "/api/image/departure-2"},
